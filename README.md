...
- **Safety features** — AWAIR-oriented catalog: exits, Code Red/White meeting spots, HVAC units, extinguishers, AEDs, eye wash, spill kits, shutoffs, LOTO, confined spaces, SDS stations, room labels, and more
...
```bash
docker pull ghcr.io/ajthom90/facility-maps:0.3.1
# or
...
```bash
export FACILITY_MAPS_IMAGE=ghcr.io/ajthom90/facility-maps:0.3.1
